...
! This code was generated by Write_ChckOutLst.m at 04-Jan-2014 12:13:30.
  ...
  INTEGER(IntKi), PARAMETER      :: Time      =    0
   ...
   ! ADDITIONAL OUTPUT FOR MORISON UP TO 16 MEMBERS
   INTEGER(IntKi), PARAMETER      :: M10N1FDxi  = 4600
   INTEGER(IntKi), PARAMETER      :: M10N2FDxi  = 4601
   INTEGER(IntKi), PARAMETER      :: M10N3FDxi  = 4602
   INTEGER(IntKi), PARAMETER      :: M10N4FDxi  = 4603
   INTEGER(IntKi), PARAMETER      :: M10N5FDxi  = 4604
   INTEGER(IntKi), PARAMETER      :: M10N6FDxi  = 4605
   INTEGER(IntKi), PARAMETER      :: M10N7FDxi  = 4606
   INTEGER(IntKi), PARAMETER      :: M10N8FDxi  = 4607
   INTEGER(IntKi), PARAMETER      :: M10N9FDxi  = 4608
   
   INTEGER(IntKi), PARAMETER      :: M10N1FDyi  = 4609 
   INTEGER(IntKi), PARAMETER      :: M10N2FDyi  = 4610
   INTEGER(IntKi), PARAMETER      :: M10N3FDyi  = 4611
   INTEGER(IntKi), PARAMETER      :: M10N4FDyi  = 4612
   INTEGER(IntKi), PARAMETER      :: M10N5FDyi  = 4613
   INTEGER(IntKi), PARAMETER      :: M10N6FDyi  = 4614
   INTEGER(IntKi), PARAMETER      :: M10N7FDyi  = 4615
   INTEGER(IntKi), PARAMETER      :: M10N8FDyi  = 4616
   INTEGER(IntKi), PARAMETER      :: M10N9FDyi  = 4617
   
   INTEGER(IntKi), PARAMETER      :: M10N1FDzi  = 4618
   INTEGER(IntKi), PARAMETER      :: M10N2FDzi  = 4619
   INTEGER(IntKi), PARAMETER      :: M10N3FDzi  = 4620
   INTEGER(IntKi), PARAMETER      :: M10N4FDzi  = 4621
   INTEGER(IntKi), PARAMETER      :: M10N5FDzi  = 4622
   INTEGER(IntKi), PARAMETER      :: M10N6FDzi  = 4623
   INTEGER(IntKi), PARAMETER      :: M10N7FDzi  = 4624
   INTEGER(IntKi), PARAMETER      :: M10N8FDzi  = 4625
   INTEGER(IntKi), PARAMETER      :: M10N9FDzi  = 4626

   INTEGER(IntKi), PARAMETER      :: M11N1FDxi  = 4627
   INTEGER(IntKi), PARAMETER      :: M11N2FDxi  = 4628
   INTEGER(IntKi), PARAMETER      :: M11N3FDxi  = 4629
   INTEGER(IntKi), PARAMETER      :: M11N4FDxi  = 4630
   INTEGER(IntKi), PARAMETER      :: M11N5FDxi  = 4631
   INTEGER(IntKi), PARAMETER      :: M11N6FDxi  = 4632
   INTEGER(IntKi), PARAMETER      :: M11N7FDxi  = 4633
   INTEGER(IntKi), PARAMETER      :: M11N8FDxi  = 4634
   INTEGER(IntKi), PARAMETER      :: M11N9FDxi  = 4635
                                        
   INTEGER(IntKi), PARAMETER      :: M11N1FDyi  = 4636 
   INTEGER(IntKi), PARAMETER      :: M11N2FDyi  = 4637
   INTEGER(IntKi), PARAMETER      :: M11N3FDyi  = 4638
   INTEGER(IntKi), PARAMETER      :: M11N4FDyi  = 4639
   INTEGER(IntKi), PARAMETER      :: M11N5FDyi  = 4640
   INTEGER(IntKi), PARAMETER      :: M11N6FDyi  = 4641
   INTEGER(IntKi), PARAMETER      :: M11N7FDyi  = 4642
   INTEGER(IntKi), PARAMETER      :: M11N8FDyi  = 4643
   INTEGER(IntKi), PARAMETER      :: M11N9FDyi  = 4644
                                        
   INTEGER(IntKi), PARAMETER      :: M11N1FDzi  = 4645
   INTEGER(IntKi), PARAMETER      :: M11N2FDzi  = 4646
   INTEGER(IntKi), PARAMETER      :: M11N3FDzi  = 4647
   INTEGER(IntKi), PARAMETER      :: M11N4FDzi  = 4648
   INTEGER(IntKi), PARAMETER      :: M11N5FDzi  = 4649
   INTEGER(IntKi), PARAMETER      :: M11N6FDzi  = 4650
   INTEGER(IntKi), PARAMETER      :: M11N7FDzi  = 4651
   INTEGER(IntKi), PARAMETER      :: M11N8FDzi  = 4652
   INTEGER(IntKi), PARAMETER      :: M11N9FDzi  = 4653
                                         
   INTEGER(IntKi), PARAMETER      :: M12N1FDxi  = 4654
   INTEGER(IntKi), PARAMETER      :: M12N2FDxi  = 4655
   INTEGER(IntKi), PARAMETER      :: M12N3FDxi  = 4656
   INTEGER(IntKi), PARAMETER      :: M12N4FDxi  = 4657
   INTEGER(IntKi), PARAMETER      :: M12N5FDxi  = 4658
   INTEGER(IntKi), PARAMETER      :: M12N6FDxi  = 4659
   INTEGER(IntKi), PARAMETER      :: M12N7FDxi  = 4660
   INTEGER(IntKi), PARAMETER      :: M12N8FDxi  = 4661
   INTEGER(IntKi), PARAMETER      :: M12N9FDxi  = 4662
                                       
   INTEGER(IntKi), PARAMETER      :: M12N1FDyi  = 4663 
   INTEGER(IntKi), PARAMETER      :: M12N2FDyi  = 4664
   INTEGER(IntKi), PARAMETER      :: M12N3FDyi  = 4665
   INTEGER(IntKi), PARAMETER      :: M12N4FDyi  = 4666
   INTEGER(IntKi), PARAMETER      :: M12N5FDyi  = 4667
   INTEGER(IntKi), PARAMETER      :: M12N6FDyi  = 4668
   INTEGER(IntKi), PARAMETER      :: M12N7FDyi  = 4669
   INTEGER(IntKi), PARAMETER      :: M12N8FDyi  = 4670
   INTEGER(IntKi), PARAMETER      :: M12N9FDyi  = 4671
                                       
   INTEGER(IntKi), PARAMETER      :: M12N1FDzi  = 4672
   INTEGER(IntKi), PARAMETER      :: M12N2FDzi  = 4673
   INTEGER(IntKi), PARAMETER      :: M12N3FDzi  = 4674
   INTEGER(IntKi), PARAMETER      :: M12N4FDzi  = 4675
   INTEGER(IntKi), PARAMETER      :: M12N5FDzi  = 4676
   INTEGER(IntKi), PARAMETER      :: M12N6FDzi  = 4677
   INTEGER(IntKi), PARAMETER      :: M12N7FDzi  = 4678
   INTEGER(IntKi), PARAMETER      :: M12N8FDzi  = 4679
   INTEGER(IntKi), PARAMETER      :: M12N9FDzi  = 4680
                                         
   INTEGER(IntKi), PARAMETER      :: M13N1FDxi  = 4681
   INTEGER(IntKi), PARAMETER      :: M13N2FDxi  = 4682
   INTEGER(IntKi), PARAMETER      :: M13N3FDxi  = 4683
   INTEGER(IntKi), PARAMETER      :: M13N4FDxi  = 4684
   INTEGER(IntKi), PARAMETER      :: M13N5FDxi  = 4685
   INTEGER(IntKi), PARAMETER      :: M13N6FDxi  = 4686
   INTEGER(IntKi), PARAMETER      :: M13N7FDxi  = 4687
   INTEGER(IntKi), PARAMETER      :: M13N8FDxi  = 4688
   INTEGER(IntKi), PARAMETER      :: M13N9FDxi  = 4689
                                       
   INTEGER(IntKi), PARAMETER      :: M13N1FDyi  = 4690 
   INTEGER(IntKi), PARAMETER      :: M13N2FDyi  = 4691
   INTEGER(IntKi), PARAMETER      :: M13N3FDyi  = 4692
   INTEGER(IntKi), PARAMETER      :: M13N4FDyi  = 4693
   INTEGER(IntKi), PARAMETER      :: M13N5FDyi  = 4694
   INTEGER(IntKi), PARAMETER      :: M13N6FDyi  = 4695
   INTEGER(IntKi), PARAMETER      :: M13N7FDyi  = 4696
   INTEGER(IntKi), PARAMETER      :: M13N8FDyi  = 4697
   INTEGER(IntKi), PARAMETER      :: M13N9FDyi  = 4698
                                       
   INTEGER(IntKi), PARAMETER      :: M13N1FDzi  = 4699
   INTEGER(IntKi), PARAMETER      :: M13N2FDzi  = 4700
   INTEGER(IntKi), PARAMETER      :: M13N3FDzi  = 4701
   INTEGER(IntKi), PARAMETER      :: M13N4FDzi  = 4702
   INTEGER(IntKi), PARAMETER      :: M13N5FDzi  = 4703
   INTEGER(IntKi), PARAMETER      :: M13N6FDzi  = 4704
   INTEGER(IntKi), PARAMETER      :: M13N7FDzi  = 4705
   INTEGER(IntKi), PARAMETER      :: M13N8FDzi  = 4706
   INTEGER(IntKi), PARAMETER      :: M13N9FDzi  = 4707

   INTEGER(IntKi), PARAMETER      :: M14N1FDxi  = 4708
   INTEGER(IntKi), PARAMETER      :: M14N2FDxi  = 4709
   INTEGER(IntKi), PARAMETER      :: M14N3FDxi  = 4710
   INTEGER(IntKi), PARAMETER      :: M14N4FDxi  = 4711
   INTEGER(IntKi), PARAMETER      :: M14N5FDxi  = 4712
   INTEGER(IntKi), PARAMETER      :: M14N6FDxi  = 4713
   INTEGER(IntKi), PARAMETER      :: M14N7FDxi  = 4714
   INTEGER(IntKi), PARAMETER      :: M14N8FDxi  = 4715
   INTEGER(IntKi), PARAMETER      :: M14N9FDxi  = 4716
                                       
   INTEGER(IntKi), PARAMETER      :: M14N1FDyi  = 4717  
   INTEGER(IntKi), PARAMETER      :: M14N2FDyi  = 4718
   INTEGER(IntKi), PARAMETER      :: M14N3FDyi  = 4719
   INTEGER(IntKi), PARAMETER      :: M14N4FDyi  = 4720
   INTEGER(IntKi), PARAMETER      :: M14N5FDyi  = 4721
   INTEGER(IntKi), PARAMETER      :: M14N6FDyi  = 4722
   INTEGER(IntKi), PARAMETER      :: M14N7FDyi  = 4723
   INTEGER(IntKi), PARAMETER      :: M14N8FDyi  = 4724
   INTEGER(IntKi), PARAMETER      :: M14N9FDyi  = 4725
                                       
   INTEGER(IntKi), PARAMETER      :: M14N1FDzi  = 4726
   INTEGER(IntKi), PARAMETER      :: M14N2FDzi  = 4727
   INTEGER(IntKi), PARAMETER      :: M14N3FDzi  = 4728
   INTEGER(IntKi), PARAMETER      :: M14N4FDzi  = 4729
   INTEGER(IntKi), PARAMETER      :: M14N5FDzi  = 4730
   INTEGER(IntKi), PARAMETER      :: M14N6FDzi  = 4731
   INTEGER(IntKi), PARAMETER      :: M14N7FDzi  = 4732
   INTEGER(IntKi), PARAMETER      :: M14N8FDzi  = 4733
   INTEGER(IntKi), PARAMETER      :: M14N9FDzi  = 4734

   INTEGER(IntKi), PARAMETER      :: M15N1FDxi  = 4735 
   INTEGER(IntKi), PARAMETER      :: M15N2FDxi  = 4736
   INTEGER(IntKi), PARAMETER      :: M15N3FDxi  = 4737
   INTEGER(IntKi), PARAMETER      :: M15N4FDxi  = 4738
   INTEGER(IntKi), PARAMETER      :: M15N5FDxi  = 4739
   INTEGER(IntKi), PARAMETER      :: M15N6FDxi  = 4740
   INTEGER(IntKi), PARAMETER      :: M15N7FDxi  = 4741
   INTEGER(IntKi), PARAMETER      :: M15N8FDxi  = 4742
   INTEGER(IntKi), PARAMETER      :: M15N9FDxi  = 4743
                                       
   INTEGER(IntKi), PARAMETER      :: M15N1FDyi  = 4744
   INTEGER(IntKi), PARAMETER      :: M15N2FDyi  = 4745
   INTEGER(IntKi), PARAMETER      :: M15N3FDyi  = 4746
   INTEGER(IntKi), PARAMETER      :: M15N4FDyi  = 4747
   INTEGER(IntKi), PARAMETER      :: M15N5FDyi  = 4748
   INTEGER(IntKi), PARAMETER      :: M15N6FDyi  = 4749
   INTEGER(IntKi), PARAMETER      :: M15N7FDyi  = 4750
   INTEGER(IntKi), PARAMETER      :: M15N8FDyi  = 4751
   INTEGER(IntKi), PARAMETER      :: M15N9FDyi  = 4752
                                       
   INTEGER(IntKi), PARAMETER      :: M15N1FDzi  = 4753
   INTEGER(IntKi), PARAMETER      :: M15N2FDzi  = 4754
   INTEGER(IntKi), PARAMETER      :: M15N3FDzi  = 4755
   INTEGER(IntKi), PARAMETER      :: M15N4FDzi  = 4756
   INTEGER(IntKi), PARAMETER      :: M15N5FDzi  = 4757
   INTEGER(IntKi), PARAMETER      :: M15N6FDzi  = 4758
   INTEGER(IntKi), PARAMETER      :: M15N7FDzi  = 4759
   INTEGER(IntKi), PARAMETER      :: M15N8FDzi  = 4760
   INTEGER(IntKi), PARAMETER      :: M15N9FDzi  = 4761



   INTEGER(IntKi), PARAMETER      :: M16N1FDxi  = 4762
   INTEGER(IntKi), PARAMETER      :: M16N2FDxi  = 4763
   INTEGER(IntKi), PARAMETER      :: M16N3FDxi  = 4764
   INTEGER(IntKi), PARAMETER      :: M16N4FDxi  = 4765
   INTEGER(IntKi), PARAMETER      :: M16N5FDxi  = 4766
   INTEGER(IntKi), PARAMETER      :: M16N6FDxi  = 4767
   INTEGER(IntKi), PARAMETER      :: M16N7FDxi  = 4768
   INTEGER(IntKi), PARAMETER      :: M16N8FDxi  = 4769
   INTEGER(IntKi), PARAMETER      :: M16N9FDxi  = 4770
                                       
   INTEGER(IntKi), PARAMETER      :: M16N1FDyi  = 4771
   INTEGER(IntKi), PARAMETER      :: M16N2FDyi  = 4772
   INTEGER(IntKi), PARAMETER      :: M16N3FDyi  = 4773
   INTEGER(IntKi), PARAMETER      :: M16N4FDyi  = 4774
   INTEGER(IntKi), PARAMETER      :: M16N5FDyi  = 4775
   INTEGER(IntKi), PARAMETER      :: M16N6FDyi  = 4776
   INTEGER(IntKi), PARAMETER      :: M16N7FDyi  = 4777
   INTEGER(IntKi), PARAMETER      :: M16N8FDyi  = 4778
   INTEGER(IntKi), PARAMETER      :: M16N9FDyi  = 4779
                                       
   INTEGER(IntKi), PARAMETER      :: M16N1FDzi  = 4780
   INTEGER(IntKi), PARAMETER      :: M16N2FDzi  = 4781
   INTEGER(IntKi), PARAMETER      :: M16N3FDzi  = 4782
   INTEGER(IntKi), PARAMETER      :: M16N4FDzi  = 4783
   INTEGER(IntKi), PARAMETER      :: M16N5FDzi  = 4784
   INTEGER(IntKi), PARAMETER      :: M16N6FDzi  = 4785
   INTEGER(IntKi), PARAMETER      :: M16N7FDzi  = 4786
   INTEGER(IntKi), PARAMETER      :: M16N8FDzi  = 4787
   INTEGER(IntKi), PARAMETER      :: M16N9FDzi  = 4788
                                         
!End of code generated by Matlab script t
  ...
  INTEGER, PARAMETER             :: MNSTAi(3,9,9) = reshape((/M1N1STAxi,M1N1STAyi,M1N1STAzi, &
   ...
   INTEGER, PARAMETER             :: MNDynP(9,9)   = reshape((/M1N1DynP,M1N2DynP,M1N3DynP,M1N4DynP,M1N5DynP,M1N6DynP,M1N7DynP,M1N8DynP,M1N9DynP,  &
      ...
      INTEGER, PARAMETER             :: MNFDi(3,9,16) = reshape((/M1N1FDxi,M1N1FDyi,M1N1FDzi, &
                                                              ...
                                                              M9N9FDxi,M9N9FDyi,M9N9FDzi, &
                                                              M10N1FDxi,M10N1FDyi,M10N1FDzi, &
                                                              M10N2FDxi,M10N2FDyi,M10N2FDzi, &
                                                              M10N3FDxi,M10N3FDyi,M10N3FDzi, &
                                                              M10N4FDxi,M10N4FDyi,M10N4FDzi, &
                                                              M10N5FDxi,M10N5FDyi,M10N5FDzi, &
                                                              M10N6FDxi,M10N6FDyi,M10N6FDzi, &
                                                              M10N7FDxi,M10N7FDyi,M10N7FDzi, &
                                                              M10N8FDxi,M11N8FDyi,M11N8FDzi, &
                                                              M10N9FDxi,M11N9FDyi,M11N9FDzi, & 
                                                              M11N1FDxi,M11N1FDyi,M11N1FDzi, &   
                                                              M11N2FDxi,M11N2FDyi,M11N2FDzi, &
                                                              M11N3FDxi,M11N3FDyi,M11N3FDzi, &
                                                              M11N4FDxi,M11N4FDyi,M11N4FDzi, &
                                                              M11N5FDxi,M11N5FDyi,M11N5FDzi, &
                                                              M11N6FDxi,M11N6FDyi,M11N6FDzi, &
                                                              M11N7FDxi,M11N7FDyi,M11N7FDzi, &
                                                              M11N8FDxi,M11N8FDyi,M11N8FDzi, &
                                                              M11N9FDxi,M11N9FDyi,M11N9FDzi, &
                                                              M12N1FDxi,M12N1FDyi,M12N1FDzi, & 
                                                              M12N2FDxi,M12N2FDyi,M12N2FDzi, &
                                                              M12N3FDxi,M12N3FDyi,M12N3FDzi, &
                                                              M12N4FDxi,M12N4FDyi,M12N4FDzi, &
                                                              M12N5FDxi,M12N5FDyi,M12N5FDzi, &
                                                              M12N6FDxi,M12N6FDyi,M12N6FDzi, &
                                                              M12N7FDxi,M12N7FDyi,M12N7FDzi, &
                                                              M12N8FDxi,M12N8FDyi,M12N8FDzi, &
                                                              M12N9FDxi,M12N9FDyi,M12N9FDzi, &
                                                              M13N1FDxi,M13N1FDyi,M13N1FDzi, &  
                                                              M13N2FDxi,M13N2FDyi,M13N2FDzi, &
                                                              M13N3FDxi,M13N3FDyi,M13N3FDzi, &
                                                              M13N4FDxi,M13N4FDyi,M13N4FDzi, &
                                                              M13N5FDxi,M13N5FDyi,M13N5FDzi, &
                                                              M13N6FDxi,M13N6FDyi,M13N6FDzi, &
                                                              M13N7FDxi,M13N7FDyi,M13N7FDzi, &
                                                              M13N8FDxi,M13N8FDyi,M13N8FDzi, &
                                                              M13N9FDxi,M13N9FDyi,M13N9FDzi, &
                                                              M14N1FDxi,M14N1FDyi,M14N1FDzi, & 
                                                              M14N2FDxi,M14N2FDyi,M14N2FDzi, &
                                                              M14N3FDxi,M14N3FDyi,M14N3FDzi, &
                                                              M14N4FDxi,M14N4FDyi,M14N4FDzi, &
                                                              M14N5FDxi,M14N5FDyi,M14N5FDzi, &
                                                              M14N6FDxi,M14N6FDyi,M14N6FDzi, &
                                                              M14N7FDxi,M14N7FDyi,M14N7FDzi, &
                                                              M14N8FDxi,M14N8FDyi,M14N8FDzi, &
                                                              M14N9FDxi,M14N9FDyi,M14N9FDzi, &
                                                              M15N1FDxi,M15N1FDyi,M15N1FDzi, &
                                                              M15N2FDxi,M15N2FDyi,M15N2FDzi, &
                                                              M15N3FDxi,M15N3FDyi,M15N3FDzi, &
                                                              M15N4FDxi,M15N4FDyi,M15N4FDzi, &
                                                              M15N5FDxi,M15N5FDyi,M15N5FDzi, &
                                                              M15N6FDxi,M15N6FDyi,M15N6FDzi, &
                                                              M15N7FDxi,M15N7FDyi,M15N7FDzi, &
                                                              M15N8FDxi,M15N8FDyi,M15N8FDzi, &
                                                              M15N9FDxi,M15N9FDyi,M15N9FDzi, &
                                                              M16N1FDxi,M16N1FDyi,M16N1FDzi, & 
                                                              M16N2FDxi,M16N2FDyi,M16N2FDzi, &
                                                              M16N3FDxi,M16N3FDyi,M16N3FDzi, &
                                                              M16N4FDxi,M16N4FDyi,M16N4FDzi, &
                                                              M16N5FDxi,M16N5FDyi,M16N5FDzi, &
                                                              M16N6FDxi,M16N6FDyi,M16N6FDzi, &
                                                              M16N7FDxi,M16N7FDyi,M16N7FDzi, &
                                                              M16N8FDxi,M16N8FDyi,M16N8FDzi, &
                                                              M16N9FDxi,M16N9FDyi,M16N9FDzi/), (/3,9,16/))
...
! This code was generated by Write_ChckOutLst.m at 04-Jan-2014 12:13:30.
   CHARACTER(OutStrLenM1)  :: ValidParamAry(4788)                   ! This lists the names of the allowed parameters, which must be sorted alphabetically
   INTEGER(IntKi)          :: ParamIndxAry(4788)                   ! This lists the index into AllOuts(:) of the allowed parameters ValidParamAry(:)
   CHARACTER(OutStrLenM1)  :: ParamUnitsAry(4788)                   ! This lists the names of the allowed parameters, which must be sorted alphabetically
   ...
   IF ( p%NumOuts > 0 ) THEN
      DO J=1,p%NMOutputs 
         ...
         DO I=1,p%MOutLst(J)%NOutLoc   
            ...
            IF (J < 10) THEN !! BECAUSE BY DEFAULT MEMBER OUTPUT SHOULD BE LESS THAN 10 DUE TO THEIR ARRAY SIZE of 3 x 9 x 9
...
!   LOGICAL                                :: InvalidOutput(MaxMrsnOutputs)                        ! This array determines if the output channel is valid for this configuration
   ...
   !! ADDITIONAL MORISON DRAG OUTPUT NEED TO BE PUT IN THE BEGINNING FOR THE SORTING ALGORITHM TO WORK 
   !! (see IndexCharAry in NWTC_Num.f90)

   ValidParamAry(1:189)  =  (/ &    
                               "M10N1FDXI","M10N1FDYI","M10N1FDZI","M10N2FDXI","M10N2FDYI","M10N2FDZI", &
                               "M10N3FDXI","M10N3FDYI","M10N3FDZI","M10N4FDXI","M10N4FDYI","M10N4FDZI", &
                               "M10N5FDXI","M10N5FDYI","M10N5FDZI","M10N6FDXI","M10N6FDYI","M10N6FDZI", &
                               "M10N7FDXI","M10N7FDYI","M10N7FDZI","M10N8FDXI","M10N8FDYI","M10N8FDZI", &
                               "M10N9FDXI","M10N9FDYI","M10N9FDZI","M11N1FDXI","M11N1FDYI","M11N1FDZI","M11N2FDXI","M11N2FDYI","M11N2FDZI", &
                               "M11N3FDXI","M11N3FDYI","M11N3FDZI","M11N4FDXI","M11N4FDYI","M11N4FDZI", &
                               "M11N5FDXI","M11N5FDYI","M11N5FDZI","M11N6FDXI","M11N6FDYI","M11N6FDZI", &
                               "M11N7FDXI","M11N7FDYI","M11N7FDZI","M11N8FDXI","M11N8FDYI","M11N8FDZI","M11N9FDXI","M11N9FDYI","M11N9FDZI", &
                               "M12N1FDXI","M12N1FDYI","M12N1FDZI","M12N2FDXI","M12N2FDYI","M12N2FDZI", &
                               "M12N3FDXI","M12N3FDYI","M12N3FDZI","M12N4FDXI","M12N4FDYI","M12N4FDZI", &
                               "M12N5FDXI","M12N5FDYI","M12N5FDZI","M12N6FDXI","M12N6FDYI","M12N6FDZI", &
                               "M12N7FDXI","M12N7FDYI","M12N7FDZI","M12N8FDXI","M12N8FDYI","M12N8FDZI","M12N9FDXI","M12N9FDYI","M12N9FDZI", &
                               "M13N1FDXI","M13N1FDYI","M13N1FDZI","M13N2FDXI","M13N2FDYI","M13N2FDZI", &
                               "M13N3FDXI","M13N3FDYI","M13N3FDZI","M13N4FDXI","M13N4FDYI","M13N4FDZI", &
                               "M13N5FDXI","M13N5FDYI","M13N5FDZI","M13N6FDXI","M13N6FDYI","M13N6FDZI", &
                               "M13N7FDXI","M13N7FDYI","M13N7FDZI","M13N8FDXI","M13N8FDYI","M13N8FDZI", &
                               "M13N9FDXI","M13N9FDYI","M13N9FDZI","M14N1FDXI","M14N1FDYI","M14N1FDZI","M14N2FDXI","M14N2FDYI","M14N2FDZI", &
                               "M14N3FDXI","M14N3FDYI","M14N3FDZI","M14N4FDXI","M14N4FDYI","M14N4FDZI", &
                               "M14N5FDXI","M14N5FDYI","M14N5FDZI","M14N6FDXI","M14N6FDYI","M14N6FDZI", &
                               "M14N7FDXI","M14N7FDYI","M14N7FDZI","M14N8FDXI","M14N8FDYI","M14N8FDZI", &
                               "M14N9FDXI","M14N9FDYI","M14N9FDZI","M15N1FDXI","M15N1FDYI","M15N1FDZI","M15N2FDXI","M15N2FDYI","M15N2FDZI", &
                               "M15N3FDXI","M15N3FDYI","M15N3FDZI","M15N4FDXI","M15N4FDYI","M15N4FDZI", &
                               "M15N5FDXI","M15N5FDYI","M15N5FDZI","M15N6FDXI","M15N6FDYI","M15N6FDZI", &
                               "M15N7FDXI","M15N7FDYI","M15N7FDZI","M15N8FDXI","M15N8FDYI","M15N8FDZI","M15N9FDXI","M15N9FDYI","M15N9FDZI", &
                               "M16N1FDXI","M16N1FDYI","M16N1FDZI","M16N2FDXI","M16N2FDYI","M16N2FDZI", &
                               "M16N3FDXI","M16N3FDYI","M16N3FDZI","M16N4FDXI","M16N4FDYI","M16N4FDZI", &
                               "M16N5FDXI","M16N5FDYI","M16N5FDZI","M16N6FDXI","M16N6FDYI","M16N6FDZI", &
                               "M16N7FDXI","M16N7FDYI","M16N7FDZI","M16N8FDXI","M16N8FDYI","M16N8FDZI","M16N9FDXI","M16N9FDYI","M16N9FDZI"/) 


   ValidParamAry(190:689)  =  (/ & 
...
!   ValidParamAry(4708:4815)  =  (/ &    
!                               "M14N1FDXI","M14N1FDYI","M14N1FDZI","M14N2FDXI","M14N2FDYI","M14N2FDZI", &
!                               "M14N3FDXI","M14N3FDYI","M14N3FDZI","M14N4FDXI","M14N4FDYI","M14N4FDZI", &
!                               "M14N5FDXI","M14N5FDYI","M14N5FDZI","M14N6FDXI","M14N6FDYI","M14N6FDZI", &
!                               "M14N7FDXI","M14N7FDYI","M14N7FDZI","M14N8FDXI","M14N8FDYI","M14N8FDZI", &
!                               "M14N9FDXI","M14N9FDYI","M14N9FDZI","M15N1FDXI","M15N1FDYI","M15N1FDZI","M15N2FDXI","M15N2FDYI","M15N2FDZI", &
!                               "M15N3FDXI","M15N3FDYI","M15N3FDZI","M15N4FDXI","M15N4FDYI","M15N4FDZI", &
!                              "M15N5FDXI","M15N5FDYI","M15N5FDZI","M15N6FDXI","M15N6FDYI","M15N6FDZI", &
!                               "M15N7FDXI","M15N7FDYI","M15N7FDZI","M15N8FDXI","M15N8FDYI","M15N8FDZI","M16N9FDXI","M16N9FDYI","M16N9FDZI", &
!                               "M16N1FDXI","M16N1FDYI","M16N1FDZI","M16N2FDXI","M16N2FDYI","M16N2FDZI", &
!                               "M16N3FDXI","M16N3FDYI","M16N3FDZI","M16N4FDXI","M16N4FDYI","M16N4FDZI", &
!                               "M16N5FDXI","M16N5FDYI","M16N5FDZI","M16N6FDXI","M16N6FDYI","M16N6FDZI", &
!                               "M16N7FDXI","M16N7FDYI","M16N7FDZI","M16N8FDXI","M16N8FDYI","M16N8FDZI","M16N9FDXI","M16N9FDYI","M16N9FDZI", &
!                              "M17N1FDXI","M17N1FDYI","M17N1FDZI","M17N2FDXI","M17N2FDYI","M17N2FDZI", &
!                               "M17N3FDXI","M17N3FDYI","M17N3FDZI","M17N4FDXI","M17N4FDYI","M17N4FDZI", &
!                               "M17N5FDXI","M17N5FDYI","M17N5FDZI","M17N6FDXI","M17N6FDYI","M17N6FDZI", &
!                               "M17N7FDXI","M17N7FDYI","M17N7FDZI","M17N8FDXI","M17N8FDYI","M17N8FDZI", &
!                               "M17N9FDXI","M17N9FDYI","M17N9FDZI"/)                                 
   ...
   ParamIndxAry(1:189)  =  (/ & 
                                ...
                                M10N5FDxi , M10N5FDyi, M10N5FDzi, M10N6FDxi , M10N6FDyi , M10N6FDzi , &
                                M10N7FDxi , M10N7FDyi, M10N7FDzi, M10N8FDxi , M10N8FDyi , M10N8FDzi , &
                                M10N9FDxi , M10N9FDyi, M10N9FDzi, &
                                M11N1FDxi , M11N1FDyi, M11N1FDzi, M11N2FDxi , M11N2FDyi , M11N2FDzi , &
                                M11N3FDxi , M11N3FDyi, M11N3FDzi, M11N4FDxi , M11N4FDyi , M11N4FDzi , &
                                M11N5FDxi , M11N5FDyi, M11N5FDzi, M11N6FDxi , M11N6FDyi , M11N6FDzi , &
                                M11N7FDxi , M11N7FDyi, M11N7FDzi, M11N8FDxi , M11N8FDyi , M11N8FDzi , &
                                M11N9FDxi , M11N9FDyi, M11N9FDzi, &
                                M12N1FDxi , M12N1FDyi, M12N1FDzi, M12N2FDxi , M12N2FDyi , M12N2FDzi , &
                                M12N3FDxi , M12N3FDyi, M12N3FDzi, M12N4FDxi , M12N4FDyi , M12N4FDzi , &
                                M12N5FDxi , M12N5FDyi, M12N5FDzi, M12N6FDxi , M12N6FDyi , M12N6FDzi , &
                                M12N7FDxi , M12N7FDyi, M12N7FDzi, M12N8FDxi , M12N8FDyi , M12N8FDzi , &
                                M12N9FDxi , M12N9FDyi, M12N9FDzi, &
                                M13N1FDxi , M13N1FDyi, M13N1FDzi, M13N2FDxi , M13N2FDyi , M13N2FDzi , &
                                M13N3FDxi , M13N3FDyi, M13N3FDzi, M13N4FDxi , M13N4FDyi , M13N4FDzi , &
                                M13N5FDxi , M13N5FDyi, M13N5FDzi, M13N6FDxi , M13N6FDyi , M13N6FDzi , &
                                ...
                                M14N7FDxi , M14N7FDyi, M14N7FDzi, M14N8FDxi , M14N8FDyi , M14N8FDzi , &
                                M14N9FDxi , M14N9FDyi, M14N9FDzi, &
                                M15N1FDxi , M15N1FDyi, M15N1FDzi, M15N2FDxi , M15N2FDyi , M15N2FDzi , &
                                M15N3FDxi , M15N3FDyi, M15N3FDzi, M15N4FDxi , M15N4FDyi , M15N4FDzi , &
                                M15N5FDxi , M15N5FDyi, M15N5FDzi, M15N6FDxi , M15N6FDyi , M15N6FDzi , &
                                M15N7FDxi , M15N7FDyi, M15N7FDzi, M15N8FDxi , M15N8FDyi , M15N8FDzi , &
                                M15N9FDxi , M15N9FDyi, M15N9FDzi, &
                                M16N1FDxi , M16N1FDyi, M16N1FDzi, M16N2FDxi , M16N2FDyi , M16N2FDzi , &
                                M16N3FDxi , M16N3FDyi, M16N3FDzi, M16N4FDxi , M16N4FDyi , M16N4FDzi , &
                                M16N5FDxi , M16N5FDyi, M16N5FDzi, M16N6FDxi , M16N6FDyi , M16N6FDzi , &
                                M16N7FDxi , M16N7FDyi, M16N7FDzi, M16N8FDxi , M16N8FDyi , M16N8FDzi , &
                                M16N9FDxi , M16N9FDyi, M16N9FDzi /)

                             

   ParamIndxAry(190:689)  =  (/ & 
                                    J1Axi ,     J1Ayi ,     J1Azi ,    J1DynP ,   J1FAGxi ,   J1FAGyi ,   J1FAGzi , &
                                  J1FAMxi ,   J1FAMyi ,   J1FAMzi ,   J1FBFxi ,   J1FBFyi ,   J1FBFzi ,    J1FBxi , &
                                   J1FByi ,    J1FBzi ,    J1FDxi ,    J1FDyi ,    J1FDzi ,    J1FIxi ,    J1FIyi , &
                                   J1FIzi ,   J1FMGxi ,   J1FMGyi ,   J1FMGzi ,   J1MAGxi ,   J1MAGyi ,   J1MAGzi , &
...
!                                M16N7FDxi , M16N7FDyi, M16N7FDzi, M16N8FDxi , M16N8FDyi , M16N8FDzi , &
!                                M16N9FDxi , M16N9FDyi, M16N9FDzi, &
!                                M17N1FDxi , M17N1FDyi, M17N1FDzi, M13N2FDxi , M13N2FDyi , M13N2FDzi , &
!                                M17N3FDxi , M17N3FDyi, M17N3FDzi, M13N4FDxi , M13N4FDyi , M13N4FDzi , &
!                                M17N5FDxi , M17N5FDyi, M17N5FDzi, M13N6FDxi , M13N6FDyi , M13N6FDzi , &
!                                M17N7FDxi , M17N7FDyi, M17N7FDzi, M13N8FDxi , M13N8FDyi , M13N8FDzi , &
!                                M17N9FDxi , M17N9FDyi, M13N9FDzi /)


   ParamUnitsAry(1:189)  =  (/ &                 ! UNIT FOR MORISON DRAG ADDITIONAL OUTPUT  
   ...
   ParamUnitsAry(190:689)  =  (/ &                 ! This lists the names of the allowed parameters, which must be sorted alphabetically
                               ...
                               "(N/m)     ","(N/m)     ","(N/m)     "/)
   ParamUnitsAry(690:1189)  =  (/ &                 ! This lists the names of the allowed parameters, which must be sorted alphabetically
                               "(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ", &
                               "(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ", &
                               "(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N-m/m)   ","(N-m/m)   ", &
                               "(N-m/m)   ","(N-m/m)   ","(N-m/m)   ","(N-m/m)   ","(N-m/m)   ","(N-m/m)   ","(N-m/m)   ", &
                               ...
                               "(N-m/m)   ","(N-m/m)   ","(N-m/m)   ","(N-m/m)   ","(N-m/m)   ","(N-m/m)   ","(N-m/m)   ", &
                               "(N-m/m)   ","(N-m/m)   ","(N-m/m)   "/)
   ParamUnitsAry(1190:1689)  =  (/ &                 ! This lists the names of the allowed parameters, which must be sorted alphabetically
                               "(N-m/m)   ","(N-m/m)   ","(m/s^2)   ","(m/s^2)   ","(m/s^2)   ","(m/s)     ","(m/s)     ", &
                               "(m/s)     ","(m/s)     ","(m/s)     ","(m/s)     ","(m/s^2)   ","(m/s^2)   ","(m/s^2)   ", &
                               "(Pa)      ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ", &
                               "(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ", &
                               ...
                               "(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ", &
                               "(N/m)     ","(N/m)     ","(N/m)     "/)
   ParamUnitsAry(1690:2189)  =  (/ &                 ! This lists the names of the allowed parameters, which must be sorted alphabetically
                               "(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ", &
                               "(N-m/m)   ","(N-m/m)   ","(N-m/m)   ","(N-m/m)   ","(N-m/m)   ","(N-m/m)   ","(N-m/m)   ", &
                               "(N-m/m)   ","(N-m/m)   ","(N-m/m)   ","(N-m/m)   ","(N-m/m)   ","(N-m/m)   ","(N-m/m)   ", &
                               "(N-m/m)   ","(m/s^2)   ","(m/s^2)   ","(m/s^2)   ","(m/s)     ","(m/s)     ","(m/s)     ", &
                               ...
                               "(m/s^2)   ","(m/s^2)   ","(m/s^2)   ","(m/s)     ","(m/s)     ","(m/s)     ","(m/s)     ", &
                               "(m/s)     ","(m/s)     ","(m/s^2)   "/)
   ParamUnitsAry(2190:2689)  =  (/ &                 ! This lists the names of the allowed parameters, which must be sorted alphabetically
                               "(m/s^2)   ","(m/s^2)   ","(Pa)      ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ", &
                               "(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ", &
                               "(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ", &
                               "(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N-m/m)   ", &
                               ...
                               "(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N-m/m)   ","(N-m/m)   ", &
                               "(N-m/m)   ","(N-m/m)   ","(N-m/m)   "/)
   ParamUnitsAry(2690:3189)  =  (/ &                 ! This lists the names of the allowed parameters, which must be sorted alphabetically
                               "(N-m/m)   ","(N-m/m)   ","(N-m/m)   ","(N-m/m)   ","(N-m/m)   ","(N-m/m)   ","(N-m/m)   ", &
                               "(N-m/m)   ","(N-m/m)   ","(N-m/m)   ","(m/s^2)   ","(m/s^2)   ","(m/s^2)   ","(m/s)     ", &
                               "(m/s)     ","(m/s)     ","(m/s)     ","(m/s)     ","(m/s)     ","(m/s^2)   ","(m/s^2)   ", &
                               "(m/s^2)   ","(Pa)      ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ", &
                               ...
                               "(Pa)      ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ", &
                               "(N/m)     ","(N/m)     ","(N/m)     "/)
   ParamUnitsAry(3190:3689)  =  (/ &                 ! This lists the names of the allowed parameters, which must be sorted alphabetically
                               "(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ", &
                               "(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ", &
                               "(N/m)     ","(N-m/m)   ","(N-m/m)   ","(N-m/m)   ","(N-m/m)   ","(N-m/m)   ","(N-m/m)   ", &
                               "(N-m/m)   ","(N-m/m)   ","(N-m/m)   ","(N-m/m)   ","(N-m/m)   ","(N-m/m)   ","(N-m/m)   ", &
                               ...
                               "(N-m/m)   ","(N-m/m)   ","(N-m/m)   ","(N-m/m)   ","(N-m/m)   ","(N-m/m)   ","(N-m/m)   ", &
                               "(N-m/m)   ","(m/s^2)   ","(m/s^2)   "/)
   ParamUnitsAry(3690:4189)  =  (/ &                 ! This lists the names of the allowed parameters, which must be sorted alphabetically
                               "(m/s^2)   ","(m/s)     ","(m/s)     ","(m/s)     ","(m/s)     ","(m/s)     ","(m/s)     ", &
                               "(m/s^2)   ","(m/s^2)   ","(m/s^2)   ","(Pa)      ","(N/m)     ","(N/m)     ","(N/m)     ", &
                               "(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ", &
                               "(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ", &
                               ...
                               "(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ", &
                               "(N/m)     ","(N/m)     ","(N/m)     "/)
   ParamUnitsAry(4190:4689)  =  (/ &                 ! This lists the names of the allowed parameters, which must be sorted alphabetically
                               "(N/m)     ","(N/m)     ","(N/m)     ","(N-m/m)   ","(N-m/m)   ","(N-m/m)   ","(N-m/m)   ", &
                               "(N-m/m)   ","(N-m/m)   ","(N-m/m)   ","(N-m/m)   ","(N-m/m)   ","(N-m/m)   ","(N-m/m)   ", &
                               "(N-m/m)   ","(N-m/m)   ","(N-m/m)   ","(N-m/m)   ","(m/s^2)   ","(m/s^2)   ","(m/s^2)   ", &
                               "(m/s)     ","(m/s)     ","(m/s)     ","(m/s)     ","(m/s)     ","(m/s)     ","(m/s^2)   ", &
                               ...
                               "(m/s)     ","(m/s)     ","(m/s)     ","(m/s)     ","(m/s)     ","(m/s^2)   ","(m/s^2)   ", &
                               "(m/s^2)   ","(Pa)      ","(N/m)     "/)
   ParamUnitsAry(4690:4788)  =  (/ &                 ! This lists the names of the allowed parameters, which must be sorted alphabetically
                               "(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ", &
                               "(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ", &
                               "(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ","(N/m)     ", &
                               "(N/m)     ","(N/m)     ","(N-m/m)   ","(N-m/m)   ","(N-m/m)   ","(N-m/m)   ","(N-m/m)   ", &
...
!   INTEGER                                :: J                                         ! Generic loop-counting index.
   ...
   DO I = 1,p%NumOuts
      ...
      Indx =  IndexCharAry( OutListTmp(1:13), ValidParamAry )
